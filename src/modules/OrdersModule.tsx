        ...
        <div className="order-main">
          <div className="card order-panel orders-catalog-panel">
            ...
            <div className="pagination-row pagination-row-minimal pagination-row-angle">
              ...
              <button type="button" className="ghost-button pagination-btn angle-only" onClick={() => setProductPage((page) => Math.min(totalProductPages, page + 1))} disabled={safeProductPage === totalProductPages} aria-label="下一頁">&gt;</button>
            </div>
          </div>
        </div>
        ...
        <aside className="orders-side-column">
          <div className="card orders-quick-panel">
            ...
            <div className="pagination-row pagination-row-minimal pagination-row-angle">
              ...
              <button type="button" className="ghost-button pagination-btn angle-only" onClick={() => setQuickCustomerPage((page) => Math.min(totalQuickCustomerPages, page + 1))} disabled={safeQuickCustomerPage === totalQuickCustomerPages} aria-label="下一頁">&gt;</button>
            </div>
          </div>

...
export default function OrdersModule(props: any) {
  ...
  return (
    <section className="order-layout order-layout-shop-only">
      <div className="order-main">
        <div className="card order-panel shop-catalog-panel">
          <div className="panel-head">
            <div>
              <div className="panel-title">商品選購</div>
              <div className="panel-desc">訂購頁只保留商品、購物車、客戶與配送資料，回到最直覺的下單畫面。</div>
            </div>
          ...
          <div className="catalog-grid shop-catalog-grid">
            {filteredOrderProducts.map((item: any) => (
              <div key={item.id} className="catalog-card shop-catalog-card">
                <div className="catalog-image-slot">
                  <div className="catalog-image-placeholder">
                    <ImageIcon className="catalog-image-icon" />
                    <span>商品圖片預留區</span>
                  </div>
                </div>

                <div className="catalog-meta-row catalog-meta-row-tight">
      ...
      <div className="order-side order-side-shop-only">
        <div className="card order-panel sticky-panel shop-cart-panel">
          <div className="panel-head compact-head">
            <div>
              <div className="panel-title">購物車</div>
              <div className="panel-desc">確認商品後，直接往下填客戶與配送資料送單。</div>
            </div>
          ...
          <div className="cart-list">
            {cart.length > 0 ? cart.map((item: any) => (
              ...
              <div className="empty-order-state shop-empty-state">尚未加入商品</div>
            )}
          </div>
        ...
        <div className="card order-panel shop-customer-panel">
          <div className="panel-head">
            <div>
              <div className="panel-title">客戶與配送資料</div>
              <div className="panel-desc">放在購物車下方，依照真實下單流程往下填寫。</div>
            </div>
            <span className="badge badge-neutral">訂單主檔欄位</span>
          </div>

          <div className="quick-customer-grid quick-customer-grid-shop">

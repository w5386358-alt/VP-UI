      ...
      {accountingTab === 'ops' && (
        <>
          ...
          <section className="card order-panel">
            <div className="panel-head accounting-record-head">
              <div>
                <div className="panel-title">訂單紀錄 / 收款狀態</div>
                <div className="panel-desc">這裡直接吃目前訂單資料，新增訂單、收款、退款後都會即時同步顯示。</div>
              </div>
              <div className="accounting-record-tools">
                <label className="field-card accounting-date-card"><span className="field-label"><CalendarRange className="small-icon" />起算日</span><input type="date" value={accountingDateStart} onChange={(e) => setAccountingDateStart(e.target.value)} /></label>
                <label className="field-card accounting-date-card"><span className="field-label"><CalendarRange className="small-icon" />結算日</span><input type="date" value={accountingDateEnd} onChange={(e) => setAccountingDateEnd(e.target.value)} /></label>

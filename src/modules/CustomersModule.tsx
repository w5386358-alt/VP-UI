      ...
      <section className="product-admin-layout customers-sync-layout">
        <div className="product-admin-main">
          ...
          <div className="pagination-row">
            ...
            <button type="button" className="ghost-button pagination-btn angle-only" onClick={() => setCustomerPage((page) => Math.min(totalPages, page + 1))} disabled={safePage === totalPages} aria-label="下一頁">&gt;</button>
          </div>
          </div>
        </div>
      </section>

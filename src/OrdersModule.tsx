    ...
    <>
      ...
      <section className="order-layout">
        ...
        <div className="order-side">
          <div className="card order-panel sticky-panel order-side-sticky-panel">
            ...
            <div className="order-side-scroll">
              ...
              <div className="order-side-divider" />

              <div className="panel-head order-side-form-head">
                <div>
                  <div className="panel-title">客戶與配送資料</div>
                  <div className="panel-desc">購物車與表單整組固定在右側。</div>
                </div>
